...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private Map<Class, Callback> map = new HashMap<Class, Callback>();
    ...
    public final void run() {
        ...
        while ((!terminated)) {
            try {
                Message temp = m.awaitMessage(this);
                if (map.containsKey(temp.getClass())) {
                    Callback callback = map.get(temp.getClass());
                    callback.call(temp);
                }
